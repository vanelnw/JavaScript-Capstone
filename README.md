...
> In this project, we are setting up a Ecommerce website with basic functionalities using JavaScript modules, Webpack and APIs.
**My Shop** is a basic product listing page of an E-commerce website.
...
- cd my-folder
- git clone https://github.com/vanelnw/JavaScript-Capstone.git
